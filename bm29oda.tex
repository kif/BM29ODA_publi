...
\aff[c]{Unit for Virus Host Cell Interactions, Université Grenoble Alpes-EMBL-CNRS, 71 avenue des Martyrs, CS 90181, 38042 Grenoble, \country{France}}
...
Examples for this trend are the develoment of dedicated sample changers
...
bioSAXS sample changer \cite{SCPaper} to collect data on alternating buffer\/sample\/buffer
...
An EDNA job (task) is a top level control plugin which communicates with the outside
