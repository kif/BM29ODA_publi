...
\cite{round2008,SCtainer2009,SCchess,SCslac,SCpaper} or the integration of size
exclusion chromatography (SEC) systems into existing beamlines to ensure the 
mono-dispersity of the sample at a given time
\cite{SECbiocat,SECSWING,SECPaper2012,SECP12}.
...
As even the largest macromolecules do not elute from the SEC column immediately, 
...
using SEC-SAXS (see Figures \ref{fgr:SCcurves} and
...
\begin{figure}
\centering
\includegraphics[width=8cm]{autosub_1.png}%
