...
(\textit{HPLC_flush}) is launched to finish the processing of the experiment as
one SEC-SAXS run. 
...
non trivial to install and even more difficult to customise (
...
providing faster feed-back to the user.
