...
The matrix on the left hand site gives the pair-wise normalized spatial discrepancy (NSD) between two models, using the model alignment provided by FreeSAS.
