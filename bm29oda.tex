...
visualized. Figure~\ref{fgr:modelling} provides a flow chart of the plugin.
...
For further manual processing and modelling of the protein, we chose the smaller
striped region.
...
\textit{ab initio} modelling pipeline which may have aborted the
